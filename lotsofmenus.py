...
restaurant1 = Restaurant(creator_id=1, name="Urban Burger")

session.add(restaurant1)
session.commit()

menuItem2 = MenuItem(creator_id=1, name="Veggie Burger",
...
menuItem1 = MenuItem(creator_id=1, name="French Fries", description="with garlic and parmesan",
                     price="$2.99", course="Appetizer", restaurant=restaurant1)

session.add(menuItem1)
session.commit()

menuItem2 = MenuItem(creator_id=1, name="Chicken Burger",
...
menuItem3 = MenuItem(creator_id=1, name="Chocolate Cake", description="fresh baked and served with ice cream",
                     price="$3.99", course="Dessert", restaurant=restaurant1)

session.add(menuItem3)
session.commit()

menuItem4 = MenuItem(creator_id=1, name="Sirloin Burger", description="Made with grade A beef",
                     price="$7.99", course="Entree", restaurant=restaurant1)

session.add(menuItem4)
session.commit()

menuItem5 = MenuItem(creator_id=1, name="Root Beer", description="16oz of refreshing goodness",
                     price="$1.99", course="Beverage", restaurant=restaurant1)

session.add(menuItem5)
session.commit()

menuItem6 = MenuItem(creator_id=1, name="Iced Tea", description="with Lemon",
                     price="$.99", course="Beverage", restaurant=restaurant1)

session.add(menuItem6)
session.commit()

menuItem7 = MenuItem(creator_id=1, name="Grilled Cheese Sandwich",
...
menuItem8 = MenuItem(creator_id=1, name="Veggie Burger",
...
restaurant2 = Restaurant(creator_id=1, name="Super Stir Fry")

session.add(restaurant2)
session.commit()

menuItem1 = MenuItem(creator_id=1, name="Chicken Stir Fry",
...
menuItem2 = MenuItem(creator_id=1, name="Peking Duck",
...
menuItem3 = MenuItem(creator_id=1, name="Spicy Tuna Roll",
...
menuItem4 = MenuItem(creator_id=1, name="Nepali Momo ",
...
menuItem5 = MenuItem(creator_id=1, name="Beef Noodle Soup",
...
menuItem6 = MenuItem(creator_id=1, name="Ramen",
...
restaurant1 = Restaurant(creator_id=1, name="Panda Garden")

session.add(restaurant1)
session.commit()

menuItem1 = MenuItem(creator_id=1, name="Pho",
...
menuItem2 = MenuItem(creator_id=1, name="Chinese Dumplings",
...
menuItem3 = MenuItem(creator_id=1, name="Gyoza",
...
menuItem4 = MenuItem(creator_id=1, name="Stinky Tofu",
...
restaurant1 = Restaurant(creator_id=1, name="Thyme for That Vegetarian Cuisine ")

session.add(restaurant1)
session.commit()

menuItem1 = MenuItem(creator_id=1, name="Tres Leches Cake",
...
menuItem2 = MenuItem(creator_id=1, name="Mushroom risotto", description="Portabello mushrooms in a creamy risotto",
                     price="$5.99", course="Entree", restaurant=restaurant1)

session.add(menuItem2)
session.commit()

menuItem3 = MenuItem(creator_id=1, name="Honey Boba Shaved Snow",
...
menuItem4 = MenuItem(creator_id=1, name="Cauliflower Manchurian",
...
menuItem5 = MenuItem(creator_id=1, name="Aloo Gobi Burrito",
...
restaurant1 = Restaurant(creator_id=1, name="Tony\'s Bistro ")

session.add(restaurant1)
session.commit()

menuItem1 = MenuItem(creator_id=1, name="Shellfish Tower",
...
menuItem2 = MenuItem(creator_id=1, name="Chicken and Rice", description="Chicken... and rice",
                     price="$4.95", course="Entree", restaurant=restaurant1)

session.add(menuItem2)
session.commit()

menuItem3 = MenuItem(creator_id=1, name="Mom's Spaghetti",
...
menuItem4 = MenuItem(creator_id=1, name="Choc Full O\' Mint (Smitten\'s Fresh Mint Chip ice cream)",
...
menuItem5 = MenuItem(creator_id=1, name="Tonkatsu Ramen",
...
# Menu for Andala's
restaurant1 = Restaurant(creator_id=1, name="Andala\'s")

session.add(restaurant1)
session.commit()

menuItem1 = MenuItem(creator_id=1, name="Lamb Curry",
...
menuItem2 = MenuItem(creator_id=1, name="Chicken Marsala",
...
menuItem3 = MenuItem(creator_id=1, name="Potstickers",
...
menuItem4 = MenuItem(creator_id=1, name="Nigiri Sampler", description="Maguro, Sake, Hamachi, Unagi, Uni, TORO!",
...
restaurant1 = Restaurant(creator_id=1, name="Auntie Ann\'s Diner' ")

session.add(restaurant1)
session.commit()

menuItem9 = MenuItem(creator_id=1, name="Chicken Fried Steak",
...
menuItem1 = MenuItem(creator_id=1, name="Boysenberry Sorbet",
...
menuItem2 = MenuItem(creator_id=1, name="Broiled salmon",
...
menuItem3 = MenuItem(creator_id=1, name="Morels on toast (seasonal)",
...
menuItem4 = MenuItem(creator_id=1, name="Tandoori Chicken",
...
menuItem10 = MenuItem(creator_id=1, name="Spinach Ice Cream",
...
restaurant1 = Restaurant(creator_id=1, name="Cocina Y Amor ")

session.add(restaurant1)
session.commit()

menuItem1 = MenuItem(creator_id=1, name="Super Burrito Al Pastor",
...
menuItem2 = MenuItem(creator_id=1, name="Cachapa",
...
restaurant1 = Restaurant(creator_id=1, name="State Bird Provisions")
session.add(restaurant1)
session.commit()

menuItem1 = MenuItem(creator_id=1, name="Chantrelle Toast",
...
menuItem1 = MenuItem(creator_id=1, name="Guanciale Chawanmushi",
...
menuItem1 = MenuItem(creator_id=1, name="Lemon Curd Ice Cream Sandwich",
